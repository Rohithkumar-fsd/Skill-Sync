...
<skill>
<name>remote-browser</name>
<description>Controls a local browser from a sandboxed remote machine. Use when the agent is running in a sandbox (no GUI) and needs to navigate websites, interact with web pages, fill forms, take screenshots, or expose local dev servers via tunnels.</description>
<location>global</location>
</skill>
