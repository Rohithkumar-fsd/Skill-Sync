  ...
  return (
    <AppShell>
      ...
      <div className="w-full max-w-3xl">
        ...
        <Card className="shadow-sm border border-gray-200 bg-white transition-colors">
          ...
          <CardContent className="p-4 sm:p-5 md:p-6 space-y-6 sm:space-y-8">
            ...
            >
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-1.5 bg-white border-gray-200 focus:border-black focus:ring-black text-gray-900 placeholder:text-gray-400"
                />
              </div>
              ...
              <div>
                ...
                <Select value={formData.education} onValueChange={(value) => setFormData({ ...formData, education: value })}>
                  <SelectTrigger className="mt-1.5 bg-white border-gray-200 focus:border-black focus:ring-black text-gray-900">
                    <SelectValue placeholder="Select your education level" />
                  </SelectTrigger>
                  <SelectContent className="bg-white border-gray-200">
                    {EDUCATION_LEVELS.map((level) => (
                      <SelectItem key={level} value={level} className="text-gray-900 focus:bg-gray-100">
                        {level}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="pt-2 border-t border-gray-100">
                ...
                <div className="flex gap-2 mt-1.5">
                  <Input
                    ...
                    className="bg-white border-gray-200 focus:border-black text-gray-900 placeholder:text-gray-400"
                  />
            ...
            <motion.div
              ...
              className="space-y-4 sm:space-y-5"
            >
              <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-foreground pb-2 border-b border-gray-200 dark:border-border">Career Interests</h3>
              <div>
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 sm:p-3.5 rounded-lg text-xs sm:text-sm font-semibold transition-all duration-200 border-2 ${isSelected
                          ? 'border-black dark:border-white bg-gray-50 dark:bg-accent shadow-md transform scale-[1.02]'
                          : 'border-gray-200 dark:border-border hover:border-gray-400 dark:hover:border-zinc-500 bg-white dark:bg-accent/20 hover:shadow-sm'
                          }`}
                      >
                        <IconComponent className={`w-6 h-6 sm:w-7 sm:h-7 mb-1 mx-auto ${isSelected ? 'text-black dark:text-foreground' : 'text-gray-600 dark:text-gray-500'}`} />
                        <div className={`text-center leading-tight ${isSelected ? 'text-black dark:text-foreground' : 'text-gray-700 dark:text-gray-400'}`}>{domain.name}</div>
                      </button>
                    );
                  })}
                </div>
              ...
              <div className="pt-2 border-t border-gray-100 dark:border-border">
                ...
                <div className="flex gap-2 mt-1.5">
                  <Input
                    ...
                    className="bg-white dark:bg-accent border-gray-200 dark:border-border focus:border-black dark:focus:border-white text-gray-900 dark:text-foreground placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  />
              ...
              {formData.interests.length > 0 && (
                <div className="pt-3 border-t border-gray-100 dark:border-border bg-gray-50 dark:bg-accent/50 rounded-xl p-3">
                  <p className="text-xs sm:text-sm font-bold text-gray-900 dark:text-foreground mb-2">Selected Interests ({formData.interests.length})</p>
                  <div className="flex flex-wrap gap-1.5">
            ...
            <motion.div
              ...
              className="space-y-3 sm:space-y-4"
            >
              <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-foreground pb-2 border-b border-gray-200 dark:border-border">Goals & Experience</h3>
              <div>
                ...
                <Textarea
                  ...
                  className="mt-1.5 min-h-[100px] sm:min-h-[120px] bg-white dark:bg-accent border-gray-200 dark:border-border focus:border-black dark:focus:border-white focus:ring-black dark:focus:ring-white/20 text-gray-900 dark:text-foreground placeholder:text-gray-400 dark:placeholder:text-gray-500"
                />
              </div>
